<?php
    ...
    function containsOrigin($rectangle){
        $x = getX($rectangle['startPoint']) + getWidth($rectangle);
        $y = getY($rectangle['startPoint']) - getHeight($rectangle);
        $rightDownPoint = makeDecartPoint($x, $y);
        return getQuadrant($rectangle['startPoint']) == 2 && getQuadrant($rightDownPoint) == 4;
    }
